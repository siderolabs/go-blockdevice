...
func TestControl(t *testing.T) {
	...
	t.Cleanup(func() {
		if !removed {
			assert.NoError(t, control.RemoveDevice(devicemapper.ByUUID(id.UUID)))
		}
	})
	...
	t.Run("read-only device", func(t *testing.T) {
		...
		t.Cleanup(func() {
			assert.NoError(t, control.RemoveDevice(devicemapper.ByUUID(readOnly.UUID)))
		})
	...
	t.Run("remove by UUID", func(t *testing.T) {
		require.NoError(t, control.RemoveDevice(devicemapper.ByUUID(id.UUID)))
